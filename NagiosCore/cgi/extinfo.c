...
void show_service_info(void) {
	...
	if(temp_svcstatus->has_been_checked == FALSE)
		...
		if(strcmp(temp_svcstatus->description, "IPMI"))
			...
			printf("<TR><TD CLASS='dataVar' VALIGN='top'>Performance Data New: </td><td><a href='http://10.129.26.133/index.php?%s' target="<?php echo $link_target;?>">IPMI_DETAILS</a></td></tr>", temp_service->host_name);
